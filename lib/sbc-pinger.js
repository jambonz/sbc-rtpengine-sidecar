      ...
      try {
        ...
        lifecycleEmitter
          .on(LifeCycleEvents.ScaleIn, async() => {
            ...
            /* poll rtpengine until calls have dried up, then complete the scale-in;
               require two consecutive zero readings since the SBCs may take up to ~30s
               to remove us from their roster of active rtpengines */
